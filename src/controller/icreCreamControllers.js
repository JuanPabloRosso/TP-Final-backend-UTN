...
const createIceCream = async (req, res) => {
    ...
    try {
        ...
        const newIceCream = await iceCreamModels.createIceCream({name, price, description, stock});
...
export {getAllIceCream, getIceCreamById, createIceCream, updateIceCream, deleteIceCream} 